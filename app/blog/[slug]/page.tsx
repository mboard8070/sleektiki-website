    ...
    <main className="relative z-[1] min-h-screen bg-[var(--background)] text-[var(--text-primary)]">
      ...
      <article>
        <header className="pt-20">
          ...
          <div className="blog-article-header-copy">
            <Link
              href="/blog"
              className="blog-article-back inline-flex items-center gap-2 text-sm text-[var(--text-secondary)] transition-colors hover:text-[var(--accent)]"
            >
              <span aria-hidden="true">Back</span>
              Blog
            </Link>
            <p className="blog-article-kicker text-xs tracking-[0.3em] uppercase text-[var(--accent)] font-[family-name:var(--font-geist-mono)]">
              {post.category}
            </p>
            <h1 className="blog-article-title text-4xl font-bold tracking-tight sm:text-5xl">
              {post.title}
            </h1>
            <p className="blog-article-description text-lg leading-8 text-[var(--text-secondary)] sm:text-xl">
              {post.description}
            </p>
        ...
        <div className="blog-article-shell">
          ...
          <div className="blog-body-sections">
            {post.sections.map((section) => (
              <section key={section.heading} className="blog-body-section">
                <h2 className="text-2xl font-semibold tracking-tight">
                  {section.heading}
                </h2>
                <div className="blog-body-copy">
          ...
          {post.relatedProjects && (
            <aside className="blog-related-work">
