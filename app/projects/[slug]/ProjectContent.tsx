...
export default function ProjectContent({
  ...
  return (
    <>
      ...
      {/* Roadmap */}
      {project.roadmap && project.roadmap.items.length > 0 && (
        <div style={{ marginBottom: "6rem" }}>
          <h2
            className="text-2xl font-bold"
            style={{ marginBottom: "1.5rem" }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {project.roadmap.items.map((item, i) => (
              <motion.div
              ...
              >
                ...
                >
                  ...
                  <span
                    className="text-[10px] uppercase rounded-full border border-[var(--surface-border)] text-[var(--text-secondary)] font-[family-name:var(--font-geist-mono)]"
                    style={{ padding: "0.25rem 0.65rem", whiteSpace: "nowrap" }}
                  >
                    {item.status}
                  </span>
                </div>
