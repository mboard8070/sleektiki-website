...
const portfolioItems: PortfolioItem[] = [
  ...
  {
    src: "/images/portfolio/pixelus_beer_ba.png",
    videoSrc: "/videos/pixelus_beer_wipe.mp4",
    title: "BASECAMP Amber Ale",
    subject: "Beer",
    scene: "Warm bar top with pint glass",
    model: "FLUX + Inpainting",
    tags: ["Beverage", "Lifestyle", "Video"],
    category: "product",
    aspect: "square",
  },
  {
    src: "/images/portfolio/pixelus_candle_ba.png",
    videoSrc: "/videos/pixelus_candle_wipe.mp4",
    title: "EMBER & OAK",
    subject: "Candle",
    scene: "Cozy living room side table",
    model: "FLUX + Inpainting",
    tags: ["Home", "Lifestyle", "Video"],
    category: "product",
    aspect: "square",
  },
  {
    src: "/images/portfolio/pixelus_coffee_ba.png",
    videoSrc: "/videos/pixelus_coffee_wipe.mp4",
    title: "FIRST LIGHT Roasters",
    subject: "Coffee",
    scene: "Morning pour-over with scattered beans",
    model: "FLUX + Inpainting",
    tags: ["Beverage", "Lifestyle", "Video"],
    category: "product",
    aspect: "square",
  ...
  {
    src: "/images/portfolio/pixelus_hotsauce_ba.png",
    videoSrc: "/videos/pixelus_hotsauce_wipe.mp4",
    title: "LAST NERVE Hot Sauce",
    subject: "Hot Sauce",
    scene: "Slate board with charred peppers and garlic",
    model: "FLUX + Inpainting",
    tags: ["Food", "Lifestyle", "Video"],
    category: "product",
    aspect: "square",
  },
  {
    src: "/images/portfolio/pixelus_shampoo_ba.png",
    videoSrc: "/videos/pixelus_shampoo_wipe.mp4",
    title: "SILK THEORY",
    subject: "Shampoo",
    scene: "Marble spa ledge with eucalyptus and steam",
    model: "FLUX + Inpainting",
    tags: ["Personal Care", "Luxury", "Video"],
    category: "product",
    aspect: "square",
  },
