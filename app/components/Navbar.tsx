...
const navLinks = [
  ...
  { href: "/projects/maude-mac", label: "MAUDE" },
      ...
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between" style={{ paddingLeft: "max(1.5rem, 5vw)", paddingRight: "max(1.5rem, 5vw)" }}>
        ...
        >
          <motion.span
            ...
            className="w-5 h-[1.5px] bg-[var(--text-secondary)] block"
          />
          <motion.span
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#050508]/95 backdrop-blur-xl border-b border-[#252530] overflow-hidden"
          >
