...
export const reelCases: ReelCase[] = [
  ...
  },
  {
    ...
    index: "03",
    chapter: "Product",
    title: "Tide · Old Spice",
    year: "2026",
    role: "Product placement · image-to-video",
    tools: ["Pixelus", "Wan 2.5"],
    summary:
      "Approved pack shots into campaign scenes, then 10-second motion: Tide on a surfboard, Old Spice Deep Sea on a wreck, Eaglefangs in a cliff nest. Product stays locked.",
    href: "/projects/pixelus-mobile",
    poster: "/images/projects/pixelus_mobile_tide_surf.png",
    videoSrc: "/videos/pixelus/tide_surf_10s.mp4",
  },
  {
    slug: "astronaut",
    index: "04",
...
export const reelClips: ReelClip[] = [
  ...
  {
    title: "Tide Surf",
    subtitle: "Pixelus · P&G product motion",
    poster: "/images/projects/pixelus_mobile_tide_surf.png",
    videoSrc: "/videos/pixelus/tide_surf_10s.mp4",
    href: "/projects/pixelus-mobile",
  },
  {
    title: "Old Spice Deep Sea",
    subtitle: "Pixelus · P&G product motion",
    poster: "/images/projects/pixelus_mobile_deep_sea_underwater.png",
    videoSrc: "/videos/pixelus/deep_sea_10s.mp4",
    href: "/projects/pixelus-mobile",
  },
  {
    title: "Old Spice Eaglefangs",
    subtitle: "Pixelus · P&G product motion",
    poster: "/images/projects/pixelus_mobile_eaglefangs_nest.png",
    videoSrc: "/videos/pixelus/eaglefangs_10s.mp4",
    href: "/projects/pixelus-mobile",
  },
  {
